...
const settings = `import React, { useState, useEffect } from 'react';
...
fs.writeFileSync('src/pages/SettingsPage.jsx', settings);
console.log('SettingsPage written:', fs.statSync('src/pages/SettingsPage.jsx').size, 'bytes');
